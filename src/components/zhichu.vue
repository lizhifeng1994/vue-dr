	    ...
	    <div class="col-lg-offset-2 col-lg-5">
	        <form class="form-horizontal" method="post" id="zhichuForm">
	           <div class="form-group">
	                ...
	                <div class="col-lg-5">
	                    <div class="input-group date comm_datetime"  data-date-format="dd MM yyyy" data-link-field="dtp_input1">
	    ...
	    <div class="col-lg-offset-0  col-lg-3">
	        <div class="panel panel-primary">
	            <div class="panel-heading">
	                <span style="margin-left: 10px;" id="show_hf_date" class="input-append date comm_datetime" data-link-field="dtp_input2">今日消费</span>
	            ...
	            <div class="panel-body list-group">
	                    ...
	                    <b>早餐</b>
	                    <span class="label label-danger pull-right">-20元</span>
	                </li>
